...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Michael Dorner"
  # s.authors            = { "Michael Dorner" => "michael.dorner@fau.de" }
  # s.social_media_url   = "http://twitter.com/Michael Dorner"
  ...
  s.source       = { :git => "https://github.com/michaeldorner/ByteBackpacker.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ByteBackpacker/ByteBackpacker.swift"
  #s.public_header_files = "ByteBackpacker/ByteBackpacker.h"
